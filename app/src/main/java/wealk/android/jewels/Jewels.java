...
import wealk.android.jewels.constants.IGameEnum;
 ...
 */
public class Jewels extends BaseGameActivity implements IOnSceneTouchListener, IConstants,IGameEnum {
	...
	*/
	class ExampleGestureListener extends GestureDetector.SimpleOnGestureListener{
	    ...
	    public boolean onDown(MotionEvent ev) {
	    	Log.e("degub","手势场景按下：("+ (ev.getX()-16) +","+(ev.getY()-12)+")="+CELL_WIDTH+"=" );
	      return true;
	    }
	    ...
	    //Toast.makeText(AndroidGestureExample.this, "Fling.", Toast.LENGTH_SHORT).show();
	    	Log.e("degub",e1.getX() +","+e1.getY() +"="+ e2.getX()+","+e2.getY());
	      return true;
	...
	private void doTips(){
		...
		if(mDeadArrList.size() > 0){		
			...
			Log.e("debug", "这里是死局==========提醒检测可消除"+mDeadArrList.size());
