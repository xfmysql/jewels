...
//				this.mModelScene.back();
	...
	private String getPhoneNumber(){   
	    ...
	    String imei = mTelephonyMgr.getDeviceId(); //取出IMEI
	    String tel = mTelephonyMgr.getLine1Number(); //取出MSISDN，很可能为空
	    String ICCID =mTelephonyMgr.getSimSerialNumber(); //取出ICCID
	    String IMSI =mTelephonyMgr.getSubscriberId(); //取出IMSI
	    if (IMSI.startsWith("46000") || IMSI.startsWith("46002")) {  
            String ProvidersName = "中国移动";  
        } else if (IMSI.startsWith("46001")) {  
        	String ProvidersName = "中国联通";  
        } else if (IMSI.startsWith("46003")) {  
        	String ProvidersName = "中国电信";  
        }  
	    return tel;   
	}  
